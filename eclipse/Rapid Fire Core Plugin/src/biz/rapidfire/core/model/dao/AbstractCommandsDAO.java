...
public abstract class AbstractCommandsDAO {
    ...
    private IRapidFireCommandResource produceCommand(ResultSet resultSet, IRapidFireFileResource file) throws SQLException {
        ...
        IRapidFireCommandResource conversionResource = createCommandInstance(file, commandType, sequence);
    ...
    protected abstract IRapidFireCommandResource createCommandInstance(IRapidFireFileResource file, String commandType, int sequence);
