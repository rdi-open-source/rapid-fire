...
public class CopyJobHandler extends AbstractHandler implements IHandler {
        ...
        try {
            ...
            if (selection instanceof IStructuredSelection) {
                ...
                while (iterator.hasNext()) {
                    ...
                    System.out.println("Copying Rapid Fire job ... " + job.getName() + " (" + subSystem.getClass() + ")");
                }
            }

        } catch (Exception e) {
            RapidFireCorePlugin.logError("*** Error in CopyJobHandler. ***", e); //$NON-NLS-1$
        }
        return null;
    }
