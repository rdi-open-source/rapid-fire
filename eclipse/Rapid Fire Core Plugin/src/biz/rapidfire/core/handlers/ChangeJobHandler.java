...
public class ChangeJobHandler extends AbstractHandler implements IHandler {
        ...
        try {
            ...
            if (selection instanceof IStructuredSelection) {
                ...
                while (iterator.hasNext()) {
                    ...
                    System.out.println("Changing Rapid Fire job ... " + job.getName() + " (" + subSystem.getClass() + ")");
                }
            }

        } catch (Exception e) {
            RapidFireCorePlugin.logError("*** Error in ChangeJobHandler. ***", e); //$NON-NLS-1$
        }
        return null;
    }
