...
public class ResetJobHandler extends AbstractHandler implements IHandler {
        ...
        try {
            ...
            if (selection instanceof IStructuredSelection) {
                ...
                while (iterator.hasNext()) {
                    ...
                    System.out.println("Reseting Rapid Fire job ... " + job.getName() + " (" + subSystem.getClass() + ")");
                }
            }

        } catch (Exception e) {
            RapidFireCorePlugin.logError("*** Error in ResetJobHandler. ***", e); //$NON-NLS-1$
        }
        return null;
    }
