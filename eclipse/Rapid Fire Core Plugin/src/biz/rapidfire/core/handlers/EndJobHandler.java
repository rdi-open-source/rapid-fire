...
public class EndJobHandler extends AbstractHandler implements IHandler {
        ...
        try {
            ...
            if (selection instanceof IStructuredSelection) {
                ...
                while (iterator.hasNext()) {
                    ...
                    System.out.println("Ending Rapid Fire job ... " + job.getName() + " (" + subSystem.getClass() + ")");
                }
            }

        } catch (Exception e) {
            RapidFireCorePlugin.logError("*** Error in EndJobHandler. ***", e); //$NON-NLS-1$
        }
        return null;
    }
