...
public class StartJobHandler extends AbstractHandler implements IHandler {
        ...
        try {
            ...
            if (selection instanceof IStructuredSelection) {
                ...
                while (iterator.hasNext()) {
                    ...
                    System.out.println("Starting Rapid Fire job ... " + job.getName() + " (" + subSystem.getClass() + ")");
                }
            }

        } catch (Exception e) {
            RapidFireCorePlugin.logError("*** Error in StartJobHandler. ***", e); //$NON-NLS-1$
        }
        return null;
    }
