...
rem *  RAPIDFIRE save file to a System i server.
rem **************************************************************
...
echo      1. RSTLIB SAVLIB(RAPIDFIRE) DEV(*SAVF)
...
echo.
echo. Stopped uploading RAPIDFIRE to host: %HOST%.
echo.
goto end

:help
echo.
echo Uploads the RAPIDFIRE save file to your iSeries.
echo.
